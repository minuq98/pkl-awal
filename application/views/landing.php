...
<head>
	...
	<div class="oz-body-wrap">
		...
		<!-- End Header Area -->
		<!-- Start Banner Area -->
		<section class="body-wrap banner-area relative" id="home">
			<div class="container">
				<div class="row fullscreen align-items-center justify-content-center">
					<div class="banner-left col-lg-6">
						<img class="d-flex mx-auto img-fluid" src="<?php echo base_url(); ?>assets/img/header-img.png" alt="">
					</div>
					<div class="col-lg-6">
		...
		<!-- End Banner Area -->
		<!-- Start Video Area -->
		<section class="body-wrap video-area pt-40 pb-40 " id="video">
			<div class="overlay overlay-bg"></div>
			<div class="container">
				<div class="video-content">
					<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="<?php echo base_url(); ?>assets/img/play-btn.png" alt=""></a>
		...
		<section class="about-area pt-100 pb-100" id="about">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6">
						<img class="img-fluid d-flex mx-auto" src="<?php echo base_url(); ?>assets/img/about.png" alt="">
					</div>
				</div>
			</div>
		</section>
		...
		<!-- Start Feature Area -->
		<!-- Start faq Area -->
		<section class="faq-area pt-100 pb-100" id="lemper">
			<div class="container">
				<div class="row">
